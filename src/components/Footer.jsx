      ...
      <main className='bg-black text-white'>
        <div className='flex flex-col sm:flex-row justify-between p-8 lg:p-14'>
          <div className='sm:w-1/3 px-4'>
            ...
            <Link to={"/envios"} className="font-bold text-gray-100 bg-red-600 hover:bg-red-400 px-4 md:px-6 py-1 md:py-2 rounded-full">Envíos</Link>
          </div>
          <div className='sm:w-1/3 px-4'>
          ...
          <div className='sm:w-1/3 px-4'>
            ...
            <Link to={"/contacto"} className="font-bold text-gray-100 bg-red-600 hover:bg-red-400 px-4 md:px-6 py-1 md:py-2 rounded-full">Contacto</Link>
          </div>
        </div>
