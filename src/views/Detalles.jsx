          ...
          <div className='m-6'>
            <div className='flex flex-col md:flex-row justify-between'>
              ...
              <div className='md:w-1/2 mx-4 md:mx-0 md:ml-12 mt-4 md:mt-0'>
                ...
                <p className='flex items-center font-semibold text-4xl'>
                  ${producto.precio}
                  {producto.descuento && (
                    <p className="font-normal text-xl ml-4 text-gray-500 line-through">${producto.descuento}</p>
                  )}
                </p>
                <button onClick={agregarAlCarrito} className={`text-lg font-semibold text-white rounded-md p-2 my-4 bg-${agregadoAlCarrito ? 'green' : 'red'}-500 hover:bg-${agregadoAlCarrito ? 'green' : 'red'}-600 transition-colors duration-300`}>
                ...
                <div className='flex items-center mb-2'>
                  ...
                  <button onClick={handleCalcularEnvio} className='rounded-md p-2 ml-4 bg-red-500 hover:bg-red-600 text-white font-bold'>Calcular</button>
                </div>
