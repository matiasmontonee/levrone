    ...
    <section id='envios'>
      <main className={`${isScrolled ? 'lg:mt-20 mt-16' : ''}`}>
        <div className='p-24 bg-red-500'>
          <h2 className='sm:text-4xl text-2xl text-white text-center font-bold'>Envíos</h2>
        </div>

        <div className='lg:px-12 px-8 lg:py-16 py-12'>
          ...
          <ol className='border-l border-red-500'>
