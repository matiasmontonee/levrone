    ...
    <section id='quienes-somos'>
      <main className={`${isScrolled ? 'lg:mt-20 mt-16' : ''}`}>
        <div className='p-24 bg-red-500'>
          <h2 className='sm:text-4xl text-2xl text-white text-center font-bold'>Quiénes somos</h2>
        </div>

        <div className='flex lg:px-12 px-8 lg:py-16 py-12 lg:flex-row flex-col'>
          <div className='lg:w-2/3'>
            <h3 className='text-2xl mb-8'>LEVRONE</h3>
            <p className='text-gray-500 mb-8'>Somos una empresa joven que tiene como objetivo brindar productos de primera calidad, es por eso que todos nuestros artículos son de empresas que fabrican con materiales importados de primer nivel.</p>
            <p className='text-gray-500 pl-8 border-l-2 lg:pr-4'>En nuestro depósito contamos con el equipamiento apropiado y las instalaciones requeridas para un correcto tratamiento de los equipos durante todo el proceso de venta, preparación y envío. <br/>
        ...
        <div className='lg:px-12 px-8'>
          ...
          <p className='text-gray-500 mb-8'>Para brindarles los mejores productos a nuestros clientes, trabajamos con marcas de primer nivel altamente reconocidas y con años de experiencia en el rubro del fitness. Es por eso que queremos presentarles a cada una de ellas, las cuales nos ofrecen su excelente equipo, y gracias a ellos, este negocio es posible.</p>
