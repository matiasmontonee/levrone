      ...
      <main className={`${isScrolled ? 'lg:mt-20 mt-16' : ''}`}>
        {carrito.length === 0 ? (
            <div className="text-center my-8 mx-4">
              ...
              <Link to="/productos" className='text-white bg-red-500 hover:bg-red-400 p-1.5 lg:p-2.5 pr-2 lg:pr-4 pl-2 lg:pl-4 rounded-full'><button>Ver productos</button></Link>
            </div>
          ) : (
          <div className='flex lg:flex-row flex-col p-8'>
            <div className='lg:pr-4 lg:w-2/3 lg:border-r lg:border-gray-600 order-2 lg:order-1'>
              <form onSubmit={handleSubmit} method='POST'>
                ...
                <button type='submit' className='flex justify-center items-center w-2/4 lg:w-1/4 mx-auto bg-red-500 mb-4 lg:mb-0 mt-4 p-2 rounded-lg text-white hover:bg-red-400 font-semibold'>Comprar <FaArrowRight className='ml-2' /></button>
              </form>
            </div>
