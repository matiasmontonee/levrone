    ...
    <section id='registro'>
      ...
      <main className="flex justify-center items-center mt-6">
        <div className="border shadow-xl rounded px-8 pt-6 pb-8 mb-4 flex flex-col w-3/4 lg:w-1/3">
          ...
          <div>
            <button className="bg-red-600 hover:bg-red-400 text-white font-bold py-2 px-4 rounded w-full focus:outline-none focus:shadow-outline" type="button" onClick={handleRegister}>Registrarse</button>
