...
const RecuperarPassword = () => {
  ...
  return (
    <section id='registro'>
      <img src={Logo} alt="Logo de Levrone" className="h-32 w-40 m-auto mt-6" />
      ...
      <main className="flex justify-center items-center mt-6">
        <div className="border shadow-xl rounded px-8 pt-6 pb-8 mb-4 flex flex-col w-3/4 lg:w-1/3">
          ...
          {step === 1 ? (
            <>
              <p className='mb-4 text-sm text-center'>Por favor revise su casilla de correo electrónico. Allí le estaremos enviando los pasos a seguir para que pueda restablecer su contraseña exitosamente.</p>
              <div className="mb-4">
              ...
              <div>
                <button className="bg-red-600 hover:bg-red-400 text-white font-bold py-2 px-4 rounded w-full focus:outline-none focus:shadow-outline" type="button" onClick={handleRegister}>Enviar correo</button>
                <p className="text-sm mt-2 text-center"><Link to={`/login`} className='text-red-600 hover:text-red-500 hover:underline'>Volver al inicio</Link></p>
              </div>
            </>
          ) : (
            <>
              <p className='mb-4 text-sm text-center'>Por favor ingrese su nueva contraseña.</p>
              ...
              <div>
                <button className="bg-red-600 hover:bg-red-400 text-white font-bold py-2 px-4 rounded w-full focus:outline-none focus:shadow-outline" type="button" onClick={handleRegister}>Recuperar contraseña</button>
                <p className="text-sm mt-2 text-center"><Link to={`/login`} className='text-red-600 hover:text-red-500 hover:underline'>Volver al inicio</Link></p>
              </div>
            </>
          )}
